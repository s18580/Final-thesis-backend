...
{
    public class CreatePersonCustomerWithDataValidator : AbstractValidator<CreatePersonCustomerWithDataCommand>
    {
        private readonly IApplicationContext _context;

        public CreatePersonCustomerWithDataValidator(IApplicationContext context)
        {
            _context = context;
        ...
        private async Task<bool> IsCompanyEmailAddressUnique(CreatePersonCustomerWithDataCommand command, CancellationToken cancellationToken)
        {
        ...
        private async Task<bool> CheckIfWorkerExists(CreatePersonCustomerWithDataCommand command, CancellationToken cancellationToken)
        {
