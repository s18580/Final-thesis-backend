...
{
    public class CreateOrderWithDataValidator : AbstractValidator<CreateOrderWithDataCommand>
    {
        private readonly IApplicationContext _context;

        public CreateOrderWithDataValidator(IApplicationContext context)
        {
            _context = context;
        ...
        private async Task<bool> DoesOrderStatusExists(CreateOrderWithDataCommand command, CancellationToken cancellationToken)
        {
        ...
        private async Task<bool> DoesRepresentativeExists(CreateOrderWithDataCommand command, CancellationToken cancellationToken)
        {
